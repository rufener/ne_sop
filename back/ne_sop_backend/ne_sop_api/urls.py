...
router.register(r"document-type", views.DocumentTypeViewSet, basename="document-type")
router.register(r"item-type-statistics-deposited", views.ItemTypeStatisticsDepositedViewSet, basename="item-type-statistics-deposited")
router.register(r"item-type-statistics-treated", views.ItemTypeStatisticsTreatedViewSet, basename="item-type-statistics-treated")
router.register(r"service-statistics", views.ServiceStatisticsViewSet, basename="service-statistics")
router.register(r"item-status-statistics", views.StatutStatisticsViewSet, basename="item-status-statistics")
